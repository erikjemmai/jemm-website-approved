(function () {
  var jemmDialogue = window.jemmHeyJemmDialogue || [
    ...
    { command: "I need to focus and study for my exam.", response: "You're all set. I've got everything ready for you — good luck studying.", state: "responding", gem: "radiant", video: "assets/videos/study-hey-jemm.mp4?v=20260716" },
