(function () {
  var jemmDialogue = window.jemmHeyJemmDialogue || [
    { command: "Tell everyone breakfast is ready.", response: "Got it — everyone's heading down now.", state: "responding", gem: "diamond", video: "assets/videos/breakfast-ready-hey-jemm.mp4" },
    { command: "I need to focus and study for my exam.", response: "You're all set. I've got everything ready for you — good luck studying.", state: "responding", gem: "radiant", video: "assets/videos/study-hey-jemm.mp4" },
    { command: "Prepare movie night", response: "Movie night is ready. Lights dimmed, shades closed, and the room is set.", state: "responding", gem: "amethyst", video: "assets/videos/movie-night-hey-jemm.mp4" }
  ];
